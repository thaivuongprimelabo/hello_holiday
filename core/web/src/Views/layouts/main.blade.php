...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-211851504-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-211851504-1');
    </script>
...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v12.0&appId=718368766225816&autoLogAppEvents=1" nonce="Xvf7WTLe"></script>
